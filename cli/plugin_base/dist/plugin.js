...
const PLUGIN_PROPERTIES = LOST_CONFIG.PluginProperties;
const ICON_NAME = LOST_CONFIG.IconName;
const ICON_TYPE = LOST_CONFIG.IconType;
const SCRIPTS = LOST_CONFIG.Scripts;
const REMOTE_SCRIPTS = LOST_CONFIG.RemoteScripts;
const FILES = LOST_CONFIG.Files;
