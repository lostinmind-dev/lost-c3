...
export abstract class Category {
    ...
    constructor(
        ...
        this.id = (id) ? clearText(id) : target.name.toLowerCase();
...
export function category(id?: string, name?: string, opts?: Partial<Options>): Function {
